...
pub use api::router;
pub use clip_path::{
    first_existing_path, imported_clip_ids, resolve_filmstrip_media, resolve_poster_media,
    resolve_waveform_media,
};
pub use gateway::ProjectMediaGateway;
...
pub use resolve::{
    ...
    proxy_policy_copy, resolve_card_media_root, resolve_import_plan, root_shot_id, use_house_media,
    virtual_name_for_derived_shot, virtual_name_for_root_clip, CardPosterKind, ImportMediaMode,
    MediaGroup,
};
